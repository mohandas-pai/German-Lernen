...
public class CustomAdapter8 extends RecyclerView.Adapter<CustomAdapter8.MyViewHolder>{
    ...
    public CustomAdapter8(ArrayList<DataModel> data) {
        this.dataSet = data;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(VerbList.myOnClickListener);
